...
class Chimp(BaseImageDataset):
    """
       C-Zoo and C-Tai Combined Datasets
       Reference:
       A. Freytag et al., "Chimpanzee faces in the wild: Log-euclidean cnns for predicting identities and attributes of primates", 2016

       Dataset statistics:
       # Original Dataset had two separate parts - the CZoo and the CTai. Both are combined here to form a single dataset
       # 20% of the ids and corresponding images are used for the test set

       # identities: 68
       # images: 2485 (train) + 662 (query) + 1496 (gallery)
       # cameras: 1
       """
