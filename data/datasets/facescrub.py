...
class FaceScrub(BaseImageDataset):
    """
       FaceScrub - Celebrity Faces Dataset
       Reference:
       H.-W. Ng and S. Winkler, "A data-driven approach to cleaning large face datasets," 2014

       URL: https://github.com/faceteam/facescrub

       Dataset statistics:
       # Quite a few of the images are missing. Only around 41000 images are available.
       # 20% of the ids and corresponding images are used for the test set

       # identities: 
       # images: 16690 (train) + 5130 (query) + 11687 (gallery)
       # cameras: 1
       """
    ...
    def __init__(self, root='../', verbose=True, **kwargs):
        ...
        if verbose:
            print("=> FaceScrub Dataset loaded")
